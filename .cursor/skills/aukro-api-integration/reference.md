...
- `node .cursor/skills/aukro-api-integration/scripts/check-changelog.mjs` (date check)
- `node .cursor/skills/aukro-api-integration/scripts/validate-skill-docs.mjs` (docs vs spec consistency and deprecation check)

## OpenAPI spec location

- **Skill asset:** `.cursor/skills/aukro-api-integration/openapi.yaml`
